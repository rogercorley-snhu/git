...
::===========================================================================================================
::-------[ TITLE 		]  :  BATCH SCRIPT : MASTER : Import Employee Demographic File
::-------[ 			]  :  *****	 WITHOUT HEADER ROW  *****
::===========================================================================================================
::
::-------[ AUTHOR		] : Roger Corley
::-------[ CREATED		] : June 02, 2015 10:23:31 PM
...
::-----------------------------------------------------------------------------------------------------------
::-------[ CREATE WINDOWS ENVIRONMENT VARIABLE ] : GEM DIRECTORY
::-----------------------------------------------------------------------------------------------------------
::
::	-- Open a Windows Command Line and enter  the following command:
::...........................................................................................................
::
::-------[  WARNING *****	] :  ONLY CHANGE THE DRIVE LETTER THAT THE
::-------[ 			] : GEM DIRECTORY IS LOCATED! Make sure to
::-------[ 			] : enclose the path in double-quotes ( "X:\GEM" )
::...........................................................................................................
::-------[ ** WARNING 	] : DO NOT INCLUDE A TRAILING SLASH AFTER "GEM"!
::-----------------------------------------------------------------------------------------------------------
::
...
:: 		setx GEM "D:\GEM"
::
::	-- After the Environment Variable is set, close the current
::	-- Command Line window, open a new Command Line and
::	-- verity the variable exists by running the following echo command:
::...........................................................................................................
::
::		echo %GEM%
...
::-----------------------------------------------------------------------------------------------------------
::	-- You may now reference the %GEM% environment variable
::	-- in this script. Only use the %...% variable. Anything past the
::	-- last % is just a reference to the directory.
::
::-------[  WARNING *****	] :  Be sure to enclose variable name AND path in double-quotes ( set "x=ab\cdpath" )
::
::-------[  WARNING *****	] :  MODIFY THESE VARIABLES ONLY IF NECESSARY!!
::
::-------[  WARNING *****	] :   DO NOT USE A TRAILING SLASH ( \ ) AFTER THE LAST SUB-DIRECTORY.
::-------[  WARNING *****	] :  VERIFY THAT ALL SUB-DIRECTORIES EXIST. CREATE IF NECESSARY.
::-----------------------------------------------------------------------------------------------------------
::
...
::@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
::
::-------[  NOTE		] : MODIFY VARIABLE VALUES AS NEEDED
::-------[  WARNING *****	] :  READ ALL INSTRUCTIONS BEFORE MODIFYING
::-------[  WARNING *****	] :  DO NOT REORDER VARIABLE POSITIONS
::
::@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
::-----------------------------------------------------------------------------------------------------------
...
::-------[  NOTE		] : 'fileType' MUST match the demographic import file type.
::
::-------[  WARNING *****	] : ONLY modify the Extension Type for 'fileType'!
::-------[ 			] : DO NOT MODIFY VARIABLE NAME!
::...........................................................................................................
::-------[  WARNING *****	] : 'tempType' is a constant used in funcRemoveHeader.
::-------[			] : DO NOT MODIFY.
::  -------------------------------------------------------------------------------------
		set "fileType=txt"
::...........................................................................................................
...
::-------[  NOTE		] : 'impFile' MUST match the demographic file name
::-------[			] : WITHOUT file extension.
::...........................................................................................................
::-------[  WARNING *****	] : 'impFull' is the full filename of 'impFile' WITH file extension.
::-------[			] : DO NOT MODIFY
::  -------------------------------------------------------------------------------------
...
::-------[  NOTE		] : 'impPath' is the full path and file name of the demographic
::-------[			] : file WITH file extension.
::...........................................................................................................
::-------[  NOTE		] : 'tempPath' is the full path-filename of the temporary file
::-------[			] : created in funcRemoveHeader
::  -------------------------------------------------------------------------------------
...
::-------[  NOTE		] : 'archFull' is the variable for the full archive file name
::-------[			] : WITHOUT file extension.
::...........................................................................................................
::-------[  NOTE		] : 'archPath' is the variable for the full path-filename
::-------[			] : of 'archFull' WITHOUT file extension
::  -------------------------------------------------------------------------------------
...
::-------[  NOTE		] : 'badFull' is the variable for the full corrupt file
::-------[  			] : name WITHOUT file extension.
::...........................................................................................................
::-------[  NOTE		] : 'badPath' is the variable for the full path-filename
::-------[  NOTE		] : of 'badFull' WITHOUT file extension
::  -------------------------------------------------------------------------------------
...
::-------[  NOTE		] : Set 'exp_num_lines' value to the minimum number
::-------[			] : of expected lines in the demographic file.
::-------------------------------------------------------------------------------------
...
::-------[  NOTE		] : MUST match sModule in SQL table cfgScriptParams
::  -------------------------------------------------------------------------------------
...
::-------[  NOTE		] : "SQLNAME=sqlservername" MUST be enclosed
::-------[			] : wihtin double-quotes ( "SQLNAME=xxxxx" )
::...........................................................................................................
::
::-------[  WARNING *****	] : If using local for SQL Server name, set variable
::-------[  			] : to "SQLNAME=(local)" - Parenthesis are REQUIRED !!
::-----------------------------------------------------------------------------------------------------------
...
::@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
::
::	'funcRemoveHeader' NOT USED AT THIS SITE -- COMMENTED OUT
::
::@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
::-----------------------------------------------------------------------------------------------------------

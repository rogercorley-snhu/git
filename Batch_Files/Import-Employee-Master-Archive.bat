...
::========================================================================================================================================
	...
	SET "impexpDIR=%gemDIR%\ImportExport"
	SET "ieArcDIR=%impexpDIR\Archive\Import-Employees-Archives"
...
::----------------------------------------------------------------------------------------------------------------------------------------
	...
	if not exist %impexpDIR%\%fileName% goto NOFILE
...
::----------------------------------------------------------------------------------------------------------------------------------------
	...
	if exist "%impexpDIR%\%fileName%" (

		move "!impexpDIR!\!fileName!" "!ieArcDIR!\!fileName!!stamp!!archExt!"
